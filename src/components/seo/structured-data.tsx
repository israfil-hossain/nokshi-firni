export default function StructuredData() {
    const organizationSchema = {
        ...
        image: 'https://nokshi.com/nokshi-firni.png',
        logo: 'https://nokshi.com/biyebari.png',
        address: {
            '@type': 'PostalAddress',
            addressCountry: 'BD',
        },
        ...
        itemListElement: [
            {
                ...
                position: 1,
                name: 'হোম',
                item: 'https://nokshi.com',
            },
            {
                '@type': 'ListItem',
                position: 2,
                name: 'পণ্য',
                item: 'https://nokshi.com#products',
            },
            {
                '@type': 'ListItem',
                position: 3,
                name: 'অর্ডার',
                item: 'https://nokshi.com#order',
            },
            {
                '@type': 'ListItem',
                position: 4,
                name: 'প্রি-অর্ডার',
                item: 'https://nokshi.com#preorder',
            },
        ],
    }
